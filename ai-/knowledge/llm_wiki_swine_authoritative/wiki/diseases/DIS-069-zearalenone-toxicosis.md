...
- ZEA 是具有雌激素样作用的霉菌毒素，解释阴户肿胀或繁殖道相关表现时应纳入饲料暴露鉴别（`SRC-0085`, PDF page 1088）。
### 鉴别诊断

- ZEA 相关表现需与正常发情、繁殖系统疾病、管理因素和其他饲料问题区分（`SRC-0085`, PDF page 1088）。
## Evidence gaps

- Optional facets without attached source-anchored evidence, if still absent below, remain source-coverage gaps: 传播途径、剖检变化、实验室诊断、防控要点
...
## 病原与分类
- 初始分类：非感染性疾病/繁殖障碍/中毒- 教材章节：Section VI Noninfectious Diseases，Chapter 69
- 正文起始页：PDF page 1079
...
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-069-zearalenone-toxicosis/001-RAU_401_600_V14.md`：RAU_401_600_V14；sources: SRC-0093。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-069-zearalenone-toxicosis/002-DOS_1_200_REVIEW_REINFORCEMENT.md`：DOS_1_200_REVIEW_REINFORCEMENT；sources: SRC-0003, SRC-0007, SRC-0008, SRC-0009, SRC-0010, SRC-0011, SRC-0012, SRC-0014。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-069-zearalenone-toxicosis/003-Formal-Disease-Completion-V5.md`：Formal Disease Completion / V5；sources: source anchors retained in expansion。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-069-zearalenone-toxicosis/004-Formal-Batch-030-V6-Source-Anchored-Completion.md`：Formal Batch 030 / V6 Source-Anchored Completion；sources: SRC-0085。
