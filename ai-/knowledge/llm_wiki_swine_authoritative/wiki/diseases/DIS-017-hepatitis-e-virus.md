...
sources: [A0-MOA-BANNED-DRUG-250-POLICY, SRC-0001, SRC-0008, SRC-0009, SRC-0012, SRC-0014, SRC-0040]
---
...
- 教材认为 HEV 具有较强人兽共患证据，但猪源 HEV 对人类疾病负担的贡献仍存在不确定性。（SRC-0014; Chapter 12 Preharvest Food Safety, Zoonotic Diseases, and the Human Health Interface; PDF page 230）

## Evidence gaps

- Optional facets without attached source-anchored evidence, if still absent below, remain source-coverage gaps: 临床症状、剖检变化、实验室诊断、鉴别诊断、防控要点
...
- 初始分类：病毒病/人兽共患风险
- 教材章节：Section III Viral Diseases，Chapter 34
- 正文起始页：PDF page 568
...
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-017-hepatitis-e-virus/001-DOS_1_200_REVIEW_REINFORCEMENT.md`：DOS_1_200_REVIEW_REINFORCEMENT；sources: SRC-0003, SRC-0007, SRC-0008, SRC-0009, SRC-0010, SRC-0011, SRC-0012, SRC-0014。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-017-hepatitis-e-virus/002-Formal-Batch-017.md`：Formal Batch 017 姝ｆ枃鎶藉彇杩涘睍；sources: SRC-0040。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-017-hepatitis-e-virus/003-Formal-Disease-Completion-V5.md`：Formal Disease Completion / V5；sources: SRC-0014。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-017-hepatitis-e-virus/004-Low-Frequency-Virus-QA-Reinforcement-V7.md`：Low Frequency Virus QA Reinforcement / V7；sources: A0-MOA-BANNED-DRUG-250-POLICY, SRC-0008, SRC-0009, SRC-0012, SRC-0040。
