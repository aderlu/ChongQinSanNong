...
- 高水平富马毒素暴露可造成肺水肿或肝毒性相关问题；解释时需要饲料检测、临床病理和群体暴露证据（`SRC-0085`, PDF page 1091-1092）。
## Evidence gaps
...
## 病原与分类
- 初始分类：非感染性疾病/中毒- 教材章节：Section VI Noninfectious Diseases，Chapter 69
- 正文起始页：PDF page 1079
...
- 富马毒素安全水平或监管限量不能从教材讨论直接外推，需另引官方饲料或监管标准（`SRC-0085`, PDF page 1092）。
## 本地证据
...
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-070-fumonisin-toxicosis/001-RAU_401_600_V14.md`：RAU_401_600_V14；sources: SRC-0093。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-070-fumonisin-toxicosis/002-DOS_1_200_REVIEW_REINFORCEMENT.md`：DOS_1_200_REVIEW_REINFORCEMENT；sources: SRC-0003, SRC-0007, SRC-0008, SRC-0009, SRC-0010, SRC-0011, SRC-0012, SRC-0014。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-070-fumonisin-toxicosis/003-Formal-Disease-Completion-V5.md`：Formal Disease Completion / V5；sources: source anchors retained in expansion。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-070-fumonisin-toxicosis/004-Formal-Batch-030-V6-Source-Anchored-Completion.md`：Formal Batch 030 / V6 Source-Anchored Completion；sources: SRC-0085。
