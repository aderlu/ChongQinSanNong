...
- 猪 torovirus 可在腹泻猪粪便中检出，但致病相关性不清楚；传播栏目只能保守写作粪便检出相关边界，不能冒充已确立传播途径。`fact_id=PTOV-001-relevance-diagnostics-boundary; source_id=SRC-0037; anchor=Chapter 31 Coronaviruses continuation; PDF page 540`

### 临床症状

- 猪 torovirus 可在腹泻猪粪便中检出，但致病相关性不清楚；临床栏目应写为腹泻病例检出相关，而非确诊性腹泻病因。`fact_id=PTOV-001-relevance-diagnostics-boundary; source_id=SRC-0037; anchor=Chapter 31 Coronaviruses continuation; PDF page 540`

### 剖检变化

- 当前可用事实未给出稳定剖检病变，且致病相关性不清楚；剖检栏目应保留为边界性证据。`fact_id=PTOV-001-relevance-diagnostics-boundary; source_id=SRC-0037; anchor=Chapter 31 Coronaviruses continuation; PDF page 540`
...
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-013-porcine-torovirus/001-DOS_1_200_REVIEW_REINFORCEMENT.md`：DOS_1_200_REVIEW_REINFORCEMENT；sources: SRC-0003, SRC-0007, SRC-0008, SRC-0009, SRC-0010, SRC-0011, SRC-0012, SRC-0014。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-013-porcine-torovirus/002-Formal-Disease-Completion-V5.md`：Formal Disease Completion / V5；sources: source anchors retained in expansion。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-013-porcine-torovirus/003-B-task.md`：B-task 核心栏目补强；sources: SRC-0037。
