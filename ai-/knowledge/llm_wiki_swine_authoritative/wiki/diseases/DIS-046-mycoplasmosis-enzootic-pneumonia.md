...
sources: [A0-MOA-573, A0-MOA-THREE-CLASS-ANIMAL-DISEASE-SPECS, A2-MERCK-MYCOPLASMAL-PNEUMONIA-PIGS-2024, RC-DISEASE-REGULATORY-001, RC-DRUG-001, RC-WITHDRAWAL-MRL-001, RULE-HANDBOOK-PRESCRIPTION-001, SRC-0001, SRC-0069, SRC-0087, SRC-0088, SRC-0089, SRC-0090]
---
...
- Phase 9 moved low-risk high-density evidence blocks out of default retrieval: `HANDBOOK_RX_V13_1`, `VTOP_V13_1`, `SFDUT_1_200_V13_1`, `SFDUT_200_363_V13_1`, `RAU_401_600_V14`.
- Moved fact-like rows: 50; moved candidate facts: 6.
...
- 初始分类：细菌病/呼吸道病
- 教材章节：Section IV Bacterial Diseases，Chapter 56
- 正文起始页：PDF page 887
...
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-046-mycoplasmosis-enzootic-pneumonia/001-HANDBOOK_RX_V13_1.md`：HANDBOOK_RX_V13_1；sources: source anchors retained in expansion。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-046-mycoplasmosis-enzootic-pneumonia/002-VTOP_V13_1.md`：VTOP_V13_1；sources: source anchors retained in expansion。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-046-mycoplasmosis-enzootic-pneumonia/003-SFDUT_1_200_V13_1.md`：SFDUT_1_200_V13_1；sources: source anchors retained in expansion。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-046-mycoplasmosis-enzootic-pneumonia/004-SFDUT_200_363_V13_1.md`：SFDUT_200_363_V13_1；sources: source anchors retained in expansion。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-046-mycoplasmosis-enzootic-pneumonia/005-RAU_401_600_V14.md`：RAU_401_600_V14；sources: source anchors retained in expansion。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-046-mycoplasmosis-enzootic-pneumonia/006-Formal-Batch-025-V3.md`：Formal Batch 025 / V3 正文抽取进展；sources: SRC-0069。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-046-mycoplasmosis-enzootic-pneumonia/007-Formal-Disease-Completion-V5.md`：Formal Disease Completion / V5；sources: source anchors retained in expansion。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-046-mycoplasmosis-enzootic-pneumonia/008-Web-Source-Reinforcement-V11.md`：Web Source Reinforcement / V11；sources: A2-MERCK-MYCOPLASMAL-PNEUMONIA-PIGS-2024, CMP-003, CMP-003-, RC-DISEASE-REGULATORY-001, RC-DRUG-001, RC-WITHDRAWAL-MRL-001, SYN-004-。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-046-mycoplasmosis-enzootic-pneumonia/001-Phase-2-Gold-Anchors-V8.md`：Phase 2 Gold Anchors / V8；sources: CMP-003-, RC-DISEASE-REGULATORY-001, RC-DRUG-001, RC-WITHDRAWAL-MRL-001, SRC-0069。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-046-mycoplasmosis-enzootic-pneumonia/002-Handbook-enrichment-V13.md`：Handbook enrichment / V13；sources: RULE-HANDBOOK-PRESCRIPTION-001, SRC-0087。
