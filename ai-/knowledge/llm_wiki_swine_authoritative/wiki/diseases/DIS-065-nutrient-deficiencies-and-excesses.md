...
### 实验室诊断
- 营养缺乏或过量诊断很少是单一直线式归因；应结合配方、原料变更、混合均匀性、热加工、储存、采食量、水源、临床表现、病变、生产记录和实验室结果解释（`SRC-0084`, PDF page 1067-1070）。
### 鉴别诊断

- 营养异常需要与感染性疾病、管理问题、饮水中断、毒物暴露和霉菌毒素问题鉴别；单个体征或单项指标不足以定因（`SRC-0084`, PDF page 1067-1070）。
### 防控要点

- 防控重点是日粮和原料审查、加工与储存控制、混料核查、水源保障以及按阶段营养需求管理（`SRC-0084`, PDF page 1068-1076）。
## Evidence gaps

- Optional facets without attached source-anchored evidence, if still absent below, remain source-coverage gaps: 传播途径、临床症状、剖检变化.
...
## 病原与分类
- 初始分类：非感染性疾病/营养代谢
- 教材章节：Section VI Noninfectious Diseases，Chapter 68
- 正文起始页：PDF page 1067
...
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-065-nutrient-deficiencies-and-excesses/001-RAU_401_600_V14.md`：RAU_401_600_V14；sources: SRC-0093。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-065-nutrient-deficiencies-and-excesses/002-DOS_1_200_REVIEW_REINFORCEMENT.md`：DOS_1_200_REVIEW_REINFORCEMENT；sources: SRC-0003, SRC-0007, SRC-0008, SRC-0009, SRC-0010, SRC-0011, SRC-0012, SRC-0014。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-065-nutrient-deficiencies-and-excesses/003-Formal-Disease-Completion-V5.md`：Formal Disease Completion / V5；sources: source anchors retained in expansion。
- `wiki/evidence_expansions/diseases/phase4_runtime_compaction/DIS-065-nutrient-deficiencies-and-excesses/004-Formal-Batch-030-V6-Source-Anchored-Completion.md`：Formal Batch 030 / V6 Source-Anchored Completion；sources: SRC-0084。
