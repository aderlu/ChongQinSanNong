---
tags: [drug, swine, sedative, cleaned_v13_2, drug_evidence_page]
drug_id: DRUG-077-azaperone
updated: 2026-05-08T23:59:00+08:00
jurisdiction: UK/EU-context-from-source
source_trust: authoritative
evidence_coverage: complete
usage_scope: [retrieval, drug_boundary, gap_routing, evidence_linked_candidate]
sources: [SRC-0088, SRC-0092]
---
...
- 来源覆盖：SRC-0088；页码锚点：5；证据扩展：见本页“证据扩展索引”。
- 已识别事实锚点：6 条。
...
- This page was created from `SRC-0088` batch extraction to capture swine-specific sedative use, dose, route and withdrawal facts from *Veterinary Treatment of Pigs*.
- Use boundary: licensing and withdrawal statements are source-date and UK/EU context unless independently verified for another jurisdiction.
...
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-077-azaperone/001-VTOP_V13_1.md`：VTOP_V13_1；sources: SRC-0088。
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-077-azaperone/002-RAU_201_400_V14.md`：RAU_201_400_V14；sources: SRC-0092。
