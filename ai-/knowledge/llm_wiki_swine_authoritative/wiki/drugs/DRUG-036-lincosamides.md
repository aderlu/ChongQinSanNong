...
drug_id: DRUG-036-lincosamides
updated: 2026-05-08T23:59:00+08:00
jurisdiction: Global
source_trust: authoritative
evidence_coverage: complete
usage_scope: [retrieval, drug_boundary, gap_routing, audit_only, boundary_only]
sources: [A0-MOA-BANNED-DRUG-250-NOTICE, A0-MOA-LABEL-INSTRUCTION-RULES-2002, A0-MOA-WITHDRAWAL-278, SRC-0012, SRC-0069, SRC-0077, SRC-0091]
...
- 来源覆盖：A0-MOA-BANNED-DRUG-250-NOTICE, A0-MOA-LABEL-INSTRUCTION-RULES-2002, A0-MOA-WITHDRAWAL-278, SRC-0012, SRC-0069, SRC-0077；页码锚点：1；证据扩展：见本页“证据扩展索引”。
- 已识别事实锚点：0 条。
...
- 农业部公告第278号列入盐酸林可霉素片和盐酸林可霉素注射液，靶动物为猪，停药期分别为6日和2日；该证据仅适用于对应林可霉素剂型，不得外推到所有林可酰胺类或复方制剂。`source_id=A0-MOA-WITHDRAWAL-278`
- 兽药标签和说明书编写细则要求适应症和用法用量按批准内容书写；林可酰胺类答案不得由教材或同类药外推剂量、疗程或休药期。`source_id=A0-MOA-LABEL-INSTRUCTION-RULES-2002`
...
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-036-lincosamides/001-RAU_1_200_V14.md`：RAU_1_200_V14；sources: SRC-0091。
