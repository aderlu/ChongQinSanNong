...
- 候选页码：PDF page 1031-1032。
- PDF 语境：外寄生虫、蜱、蝇和环境处理语境。
...
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-060-permethrin-deltamethrin/001-RAU_1_200_V14.md`：RAU_1_200_V14；sources: SRC-0091。
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-060-permethrin-deltamethrin/002-RAU_201_400_V14.md`：RAU_201_400_V14；sources: SRC-0092。
