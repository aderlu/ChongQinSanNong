...
- 候选页码：PDF page 48, 52, 193, 202, 355, 946。
- PDF 语境：去势/跛行疼痛、呼吸道疾病辅助和炎症语境。
...
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-063-meloxicam/001-VTOP_V13_1.md`：VTOP_V13_1；sources: SRC-0088。
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-063-meloxicam/001-Raw-MD-textbook-evidence-V12.md`：Raw MD textbook evidence / V12；sources: SRC-0004。
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-063-meloxicam/002-V12.md`：V12 生成与评估边界；sources: source anchors retained in expansion。
