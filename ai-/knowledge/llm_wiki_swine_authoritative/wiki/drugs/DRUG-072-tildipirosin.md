...
- 来源覆盖：A0-MOA-BANNED-DRUG-250-NOTICE, SRC-0060, SRC-0061；页码锚点：1；证据扩展：见本页“证据扩展索引”。
- 已识别事实锚点：0 条。
...
- 候选页码：PDF page 812。
- PDF 语境：Leptospirosis small-sample experimental context with oxytetracycline + tildipirosin; not a herd eradication strategy.

## 合规和安全边界

- Evidence is narrow and not a general prescription basis; verify product label, species, indication and withdrawal period.
