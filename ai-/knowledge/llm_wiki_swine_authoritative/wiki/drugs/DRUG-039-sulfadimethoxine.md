...
drug_id: DRUG-039-sulfadimethoxine
updated: 2026-05-08T23:59:00+08:00
jurisdiction: Global
source_trust: authoritative
evidence_coverage: complete
usage_scope: [retrieval, drug_boundary, gap_routing, audit_only, boundary_only]
sources: [A0-MOA-BANNED-DRUG-250-NOTICE, A0-MOA-LABEL-INSTRUCTION-RULES-2002, A0-MOA-MRL-GB31650-2019, A0-MOA-WITHDRAWAL-278, SRC-0012, SRC-0091]
...
- 来源覆盖：A0-MOA-BANNED-DRUG-250-NOTICE, A0-MOA-LABEL-INSTRUCTION-RULES-2002, A0-MOA-MRL-GB31650-2019, A0-MOA-WITHDRAWAL-278, SRC-0012；页码锚点：1；证据扩展：见本页“证据扩展索引”。
- 已识别事实锚点：0 条。
...
- 农业部公告第278号未直接以“磺胺二甲氧嘧啶”名称命中本轮抽取，但列入多种磺胺类具体品种的停药期；因此本页不得借同类磺胺或教材语境推导本药在中国猪用场景的休药期。`source_id=A0-MOA-WITHDRAWAL-278`
- GB 31650-2019 官方入口作为最大残留限量核验入口；应在取得具体条款前保留残留/MRL 待核验状态。`source_id=A0-MOA-MRL-GB31650-2019`
- 兽药标签和说明书编写细则要求适应症和用法用量不得擅自扩大；本页不能从 Actinobacillus suis 教材候选直接生成处方。`source_id=A0-MOA-LABEL-INSTRUCTION-RULES-2002`

## 教材候选证据

- 候选页码：PDF page 787。
- PDF 语境：Actinobacillus suis 后续治疗候选语境。
...
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-039-sulfadimethoxine/001-RAU_1_200_V14.md`：RAU_1_200_V14；sources: SRC-0091。
