...
drug_id: DRUG-054-virginiamycin
...
- 候选页码：PDF page 932, 983。
- PDF 语境：猪痢疾历史用药和增生性肠炎疫苗兼容性语境。
...
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-054-virginiamycin/001-RAU_1_200_V14.md`：RAU_1_200_V14；sources: SRC-0091。
