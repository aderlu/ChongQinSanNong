...
drug_id: DRUG-059-phosmet-coumaphos
...
- organophosphate ectoparasiticides

## 教材候选证据

- 候选页码：PDF page 1031-1032。
- PDF 语境：外寄生虫和环境处理候选语境。
...
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-059-phosmet-coumaphos/001-RAU_1_200_V14.md`：RAU_1_200_V14；sources: SRC-0091。
