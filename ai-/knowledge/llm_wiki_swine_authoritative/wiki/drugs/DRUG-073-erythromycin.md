...
drug_id: DRUG-073-erythromycin
updated: 2026-05-08T23:59:00+08:00
jurisdiction: Global
source_trust: authoritative
evidence_coverage: complete
usage_scope: [retrieval, drug_boundary, gap_routing, audit_only, boundary_only]
sources: [A0-MOA-BANNED-DRUG-250-NOTICE, SRC-0067, SRC-0068, SRC-0074, SRC-0089, SRC-0090, SRC-0091]
...
- 来源覆盖：A0-MOA-BANNED-DRUG-250-NOTICE, SRC-0067, SRC-0068, SRC-0074, SRC-0089, SRC-0090；页码锚点：14；证据扩展：见本页“证据扩展索引”。
- 已识别事实锚点：13 条。
...
- 候选页码：PDF page 884-885; staphylococcosis resistance boundary mentions。
- PDF 语境：Leptospirosis alternative/control candidate context; resistance boundary in Staphylococcus hyicus contexts.

## 合规和安全边界

- Older macrolide candidate; legality, label and resistance must be reviewed before any use conclusion.
...
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-073-erythromycin/001-SFDUT_1_200_V13_1.md`：SFDUT_1_200_V13_1；sources: SRC-0089。
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-073-erythromycin/002-SFDUT_200_363_V13_1.md`：SFDUT_200_363_V13_1；sources: SRC-0090。
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-073-erythromycin/003-RAU_1_200_V14.md`：RAU_1_200_V14；sources: SRC-0091。
