...
- 来源覆盖：A0-MOA-BANNED-DRUG-250-NOTICE, SRC-0004, SRC-0012, SRC-0088；页码锚点：2；证据扩展：见本页“证据扩展索引”。
- 已识别事实锚点：3 条。
...
- 候选页码：PDF page 52, 193, 209。
- PDF 语境：疼痛/跛行、猪呼吸道疾病发热和休克支持语境。
...
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-064-flunixin-meglumine/001-VTOP_V13_1.md`：VTOP_V13_1；sources: SRC-0088。
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-064-flunixin-meglumine/001-Raw-MD-textbook-evidence-V12.md`：Raw MD textbook evidence / V12；sources: SRC-0004。
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-064-flunixin-meglumine/002-V12.md`：V12 生成与评估边界；sources: source anchors retained in expansion。
