---
tags: [drug, swine, euthanasia, anaesthesia, cleaned_v13_2, drug_evidence_page]
drug_id: DRUG-078-pentobarbital
...
- 来源覆盖：SRC-0088；页码锚点：3；证据扩展：见本页“证据扩展索引”。
- 已识别事实锚点：5 条。
...
- This page was created from `SRC-0088` batch extraction to capture swine anaesthesia/euthanasia facts and product table facts from *Veterinary Treatment of Pigs*.
- Use boundary: euthanasia residues/consumption exclusions must be preserved exactly as sourced and checked against current local law before operational use.
...
- `wiki/evidence_expansions/drugs/phase4_runtime_compaction/DRUG-078-pentobarbital/001-VTOP_V13_1.md`：VTOP_V13_1；sources: SRC-0088。
