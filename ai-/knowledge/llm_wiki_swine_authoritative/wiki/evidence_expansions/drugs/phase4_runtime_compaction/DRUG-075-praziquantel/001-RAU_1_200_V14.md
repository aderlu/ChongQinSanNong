...
# DRUG-075-praziquantel / RAU 1 200 V14
...
- `RAU1-DRUG-163-DRUG-075-praziquantel-md-1049` 吡喹酮 / 抗绦虫药 / p.163：目录定位显示 `吡喹酮` 属于 `抗绦虫药`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=163`
