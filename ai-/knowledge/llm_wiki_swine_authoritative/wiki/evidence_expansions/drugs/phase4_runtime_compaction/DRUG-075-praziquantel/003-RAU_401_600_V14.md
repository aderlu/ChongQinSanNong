...
# DRUG-075-praziquantel / RAU 401 600 V14
...
- 本批来源补充中药类兽药的联用、禁忌、用药注意和症候支持边界；驱虫杀虫药章节提供中药驱虫候选和毒性边界；现代驱虫药剂量、疗程和休药期仍需标签来源。 完整事实见 `exports/veterinary_rational_use_401_600_fact_index.csv`。
