...
# DRUG-004-fenbendazole / RAU 1 200 V14
...
- `RAU1-DRUG-146-DRUG-004-fenbendazole-md-4974` 芬苯达唑 / 苯并咪唑类驱虫药 / p.146：目录定位显示 `芬苯达唑` 属于 `苯并咪唑类驱虫药`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=146`
