...
source_page: wiki/drugs/DRUG-056-levamisole.md
...
# DRUG-056-levamisole / RAU 1 200 V14
...
- `RAU1-DRUG-148-DRUG-056-levamisole-md-1817` 左旋咪唑 / 咪唑并噻唑类驱虫药 / p.148：目录定位显示 `左旋咪唑` 属于 `咪唑并噻唑类驱虫药`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=148`
