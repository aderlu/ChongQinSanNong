...
source_page: wiki/drugs/DRUG-036-lincosamides.md
...
# DRUG-036-lincosamides / RAU 1 200 V14
...
- `RAU1-DRUG-073-DRUG-036-lincosamides-md-9205` 林可胺类 / 林可胺类 / p.73：目录定位显示 `林可胺类` 属于 `林可胺类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=73`
