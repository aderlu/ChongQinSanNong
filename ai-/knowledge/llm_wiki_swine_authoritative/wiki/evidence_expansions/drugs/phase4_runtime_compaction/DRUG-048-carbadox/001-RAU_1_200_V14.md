...
source_page: wiki/drugs/DRUG-048-carbadox.md
...
# DRUG-048-carbadox / RAU 1 200 V14
...
- `RAU1-DRUG-111-DRUG-048-carbadox-md-6032` 卡巴多司 / 喹噁啉类 / p.111：目录定位显示 `卡巴多司` 属于 `喹噁啉类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=111`
