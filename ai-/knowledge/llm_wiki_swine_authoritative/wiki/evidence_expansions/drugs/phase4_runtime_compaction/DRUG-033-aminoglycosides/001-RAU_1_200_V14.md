...
source_page: wiki/drugs/DRUG-033-aminoglycosides.md
...
# DRUG-033-aminoglycosides / RAU 1 200 V14
...
- `RAU1-DRUG-050-DRUG-033-aminoglycosides-md-3289` 氨基糖苷类 / 氨基糖苷类 / p.50：目录定位显示 `氨基糖苷类` 属于 `氨基糖苷类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=50`
