...
source_page: wiki/drugs/DRUG-025-apramycin.md
...
# DRUG-025-apramycin / RAU 1 200 V14
...
- `RAU1-DRUG-056-DRUG-025-apramycin-md-3853` 安普霉素 / 氨基糖苷类 / p.56：目录定位显示 `安普霉素` 属于 `氨基糖苷类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=56`
