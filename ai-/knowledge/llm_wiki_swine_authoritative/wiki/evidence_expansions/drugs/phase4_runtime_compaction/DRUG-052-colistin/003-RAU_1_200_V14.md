...
# DRUG-052-colistin / RAU 1 200 V14
...
- `RAU1-DRUG-076-DRUG-052-colistin-md-2172` 多黏菌素E / 多肽类 / p.76：目录定位显示 `多黏菌素E` 属于 `多肽类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=76`
