...
# DRUG-026-spectinomycin / RAU 1 200 V14
...
- `RAU1-DRUG-057-DRUG-026-spectinomycin-md-3856` 大观霉素 / 氨基糖苷类 / p.57：目录定位显示 `大观霉素` 属于 `氨基糖苷类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=57`
