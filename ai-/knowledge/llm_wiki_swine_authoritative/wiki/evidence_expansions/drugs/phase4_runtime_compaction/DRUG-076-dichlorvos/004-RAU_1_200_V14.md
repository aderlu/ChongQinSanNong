...
# DRUG-076-dichlorvos / RAU 1 200 V14
...
- `RAU1-DRUG-196-DRUG-076-dichlorvos-md-4710` 敌敌畏 / 有机磷杀虫药 / p.196：目录定位显示 `敌敌畏` 属于 `有机磷杀虫药`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=196`
