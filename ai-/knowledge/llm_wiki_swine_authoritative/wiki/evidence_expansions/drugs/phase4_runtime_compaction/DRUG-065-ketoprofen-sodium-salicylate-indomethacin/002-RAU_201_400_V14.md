...
# DRUG-065-ketoprofen-sodium-salicylate-indomethacin / RAU 201 400 V14
...
- `RAU2-DRUG-219-1865` 保 泰 松 / NSAID 候选 / p.219：`保 泰 松` 在本批来源中定位为 `NSAID 候选`。 `source_id=SRC-0092; page=219`
- `RAU2-DRUG-219-0251` 吲哚美辛 / NSAID 候选 / p.219：`吲哚美辛` 在本批来源中定位为 `NSAID 候选`。 `source_id=SRC-0092; page=219`
