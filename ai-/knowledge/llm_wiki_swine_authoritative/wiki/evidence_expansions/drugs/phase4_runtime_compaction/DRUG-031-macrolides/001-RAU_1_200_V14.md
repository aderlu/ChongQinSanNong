...
source_page: wiki/drugs/DRUG-031-macrolides.md
...
# DRUG-031-macrolides / RAU 1 200 V14
...
- `RAU1-DRUG-067-DRUG-031-macrolides-md-5788` 大环内酯类 / 大环内酯类 / p.67：目录定位显示 `大环内酯类` 属于 `大环内酯类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=67`
