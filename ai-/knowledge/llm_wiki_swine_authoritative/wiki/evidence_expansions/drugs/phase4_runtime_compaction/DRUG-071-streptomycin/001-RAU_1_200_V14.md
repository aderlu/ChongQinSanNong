...
source_page: wiki/drugs/DRUG-071-streptomycin.md
...
# DRUG-071-streptomycin / RAU 1 200 V14
...
- `RAU1-DRUG-051-DRUG-071-streptomycin-md-5373` 链霉素 / 氨基糖苷类 / p.51：目录定位显示 `链霉素` 属于 `氨基糖苷类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=51`
