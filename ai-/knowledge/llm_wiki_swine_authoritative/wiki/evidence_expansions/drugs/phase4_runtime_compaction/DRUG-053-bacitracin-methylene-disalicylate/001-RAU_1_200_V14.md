...
source_page: wiki/drugs/DRUG-053-bacitracin-methylene-disalicylate.md
...
# DRUG-053-bacitracin-methylene-disalicylate / RAU 1 200 V14
...
- `RAU1-DRUG-078-DRUG-053-bacitracin-methylene-disalicylate-md-4943` 杆菌肽 / 多肽类 / p.78：目录定位显示 `杆菌肽` 属于 `多肽类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=78`
