...
# DRUG-022-sulfonamide-trimethoprim / RAU 1 200 V14
...
- `RAU1-DRUG-093-DRUG-022-sulfonamide-trimethoprim-md-2678` 甲氧苄啶 / 磺胺类/增效剂 / p.93：目录定位显示 `甲氧苄啶` 属于 `磺胺类/增效剂`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=93`
