...
# DRUG-079-atropine / RAU 401 600 V14
...
- 本批来源补充中药类兽药的联用、禁忌、用药注意和症候支持边界；商陆等与阿托品存在药效拮抗提示；阿托品执行性使用仍需来源化剂量和适应证。 完整事实见 `exports/veterinary_rational_use_401_600_fact_index.csv`。
