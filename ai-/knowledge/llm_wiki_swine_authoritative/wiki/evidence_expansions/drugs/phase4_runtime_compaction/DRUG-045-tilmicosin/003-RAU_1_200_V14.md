...
# DRUG-045-tilmicosin / RAU 1 200 V14
...
- `RAU1-DRUG-071-DRUG-045-tilmicosin-md-9479` 替米考星 / 大环内酯类 / p.71：目录定位显示 `替米考星` 属于 `大环内酯类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=71`
