...
# DRUG-029-nsaids / RAU 401 600 V14
...
- 本批来源补充中药类兽药的联用、禁忌、用药注意和症候支持边界；大黄、商陆等与解热镇痛药或阿司匹林类同用可能增加胃肠刺激/溃疡风险；仅作配伍风险提示。 完整事实见 `exports/veterinary_rational_use_401_600_fact_index.csv`。
