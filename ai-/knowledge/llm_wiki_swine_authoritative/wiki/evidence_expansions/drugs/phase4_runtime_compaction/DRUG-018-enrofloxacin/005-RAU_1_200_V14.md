...
# DRUG-018-enrofloxacin / RAU 1 200 V14
...
- `RAU1-DRUG-097-DRUG-018-enrofloxacin-md-2713` 恩诺沙星 / 喹诺酮类 / p.97：目录定位显示 `恩诺沙星` 属于 `喹诺酮类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=97`
