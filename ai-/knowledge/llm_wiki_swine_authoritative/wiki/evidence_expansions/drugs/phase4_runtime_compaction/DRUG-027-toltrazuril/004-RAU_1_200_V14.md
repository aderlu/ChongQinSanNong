...
# DRUG-027-toltrazuril / RAU 1 200 V14
...
- `RAU1-DRUG-180-DRUG-027-toltrazuril-md-5572` 妥曲珠利 / 抗球虫药 / p.180：目录定位显示 `妥曲珠利` 属于 `抗球虫药`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=180`
