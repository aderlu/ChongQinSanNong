...
source_page: wiki/drugs/DRUG-054-virginiamycin.md
...
# DRUG-054-virginiamycin / RAU 1 200 V14
...
- `RAU1-DRUG-079-DRUG-054-virginiamycin-md-9915` 维吉尼霉素 / 多肽类 / p.79：目录定位显示 `维吉尼霉素` 属于 `多肽类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=79`
