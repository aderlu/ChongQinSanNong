...
# DRUG-005-benzimidazoles / RAU 1 200 V14
...
- `RAU1-DRUG-144-DRUG-005-benzimidazoles-md-1663` 苯并咪唑类 / 苯并咪唑类 / p.144：目录定位显示 `苯并咪唑类` 属于 `苯并咪唑类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=144`
- `RAU1-DRUG-145-DRUG-005-benzimidazoles-md-3123` 阿苯达唑 / 苯并咪唑类驱虫药 / p.145：目录定位显示 `阿苯达唑` 属于 `苯并咪唑类驱虫药`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=145`
