...
source_page: wiki/drugs/DRUG-062-amprolium.md
...
# DRUG-062-amprolium / RAU 1 200 V14
...
- `RAU1-DRUG-182-DRUG-062-amprolium-md-0890` 氨丙啉 / 抗球虫药 / p.182：目录定位显示 `氨丙啉` 属于 `抗球虫药`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=182`
