...
# DRUG-002-ivermectin / RAU 1 200 V14
...
- `RAU1-DRUG-156-DRUG-002-ivermectin-md-4942` 伊维菌素 / 阿维菌素类 / p.156：目录定位显示 `伊维菌素` 属于 `阿维菌素类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=156`
