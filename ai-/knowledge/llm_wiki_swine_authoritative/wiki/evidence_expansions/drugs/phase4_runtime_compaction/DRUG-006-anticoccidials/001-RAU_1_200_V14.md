...
# DRUG-006-anticoccidials / RAU 1 200 V14
...
- `RAU1-DRUG-173-DRUG-006-anticoccidials-md-5646` 抗球虫药 / 抗球虫药 / p.173：目录定位显示 `抗球虫药` 属于 `抗球虫药`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=173`
