...
# DRUG-003-doramectin / RAU 1 200 V14
...
- `RAU1-DRUG-159-DRUG-003-doramectin-md-8031` 多拉菌素 / 阿维菌素类 / p.159：目录定位显示 `多拉菌素` 属于 `阿维菌素类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=159`
