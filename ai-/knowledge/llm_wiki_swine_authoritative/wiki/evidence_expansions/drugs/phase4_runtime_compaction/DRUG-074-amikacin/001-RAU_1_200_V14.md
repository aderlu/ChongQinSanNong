...
source_page: wiki/drugs/DRUG-074-amikacin.md
...
# DRUG-074-amikacin / RAU 1 200 V14
...
- `RAU1-DRUG-058-DRUG-074-amikacin-md-2917` 阿米卡星 / 氨基糖苷类 / p.58：目录定位显示 `阿米卡星` 属于 `氨基糖苷类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=58`
