...
# DRUG-007-antimicrobials / RAU 401 600 V14
...
- 本批来源补充中药类兽药的联用、禁忌、用药注意和症候支持边界；中药酸化、鞣质、泻下或矿物类药物可影响抗菌药吸收、排泄或毒性；抗菌药正向处方仍必须回到标签/药敏/休药期来源。 完整事实见 `exports/veterinary_rational_use_401_600_fact_index.csv`。
