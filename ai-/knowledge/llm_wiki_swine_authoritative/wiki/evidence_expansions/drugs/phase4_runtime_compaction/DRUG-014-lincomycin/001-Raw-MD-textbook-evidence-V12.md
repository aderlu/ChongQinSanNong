...
# DRUG-014-lincomycin / Raw MD textbook evidence / V12
...
- 《Diseases of Swine, 11th Edition》raw/md 本轮确认 `Lincomycin` 可作为 `Lincosamide` 相关治疗候选或边界召回；该证据来自教材正文，不是具体产品批准标签。`fact_id=V12-DRUG-014-lincomycin-raw-md-class-boundary; source_id=SRC-0012; anchor=Chapter 10; raw/md/1-200.md; antimicrobial class table`
- The textbook class table describes lincomycin as a lincosamide with activity against gram-positive aerobes, anaerobes including Brachyspira hyodysenteriae and Mycoplasma, with oral use for Brachyspira control and oral or IM use for Mycoplasma control.`fact_id=V12-DRUG-014-lincomycin-raw-md-class-boundary-detail; source_id=SRC-0012; anchor=Chapter 10; raw/md/1-200.md; antimicrobial class table`
