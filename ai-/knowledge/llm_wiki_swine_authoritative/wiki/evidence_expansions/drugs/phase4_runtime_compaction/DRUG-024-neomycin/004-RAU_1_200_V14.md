...
# DRUG-024-neomycin / RAU 1 200 V14
...
- `RAU1-DRUG-057-DRUG-024-neomycin-md-7868` 新霉素 / 氨基糖苷类 / p.57：目录定位显示 `新霉素` 属于 `氨基糖苷类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=57`
