...
# DRUG-001-avermectins / RAU 1 200 V14
...
- `RAU1-DRUG-155-DRUG-001-avermectins-md-6320` 阿维菌素类 / 阿维菌素类 / p.155：目录定位显示 `阿维菌素类` 属于 `阿维菌素类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=155`
- `RAU1-DRUG-159-DRUG-001-avermectins-md-6433` 阿维菌素 / 阿维菌素类 / p.159：目录定位显示 `阿维菌素` 属于 `阿维菌素类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=159`
