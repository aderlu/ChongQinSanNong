...
# DRUG-016-tylvalosin / RAU 1 200 V14
...
- `RAU1-DRUG-073-DRUG-016-tylvalosin-md-2347` 泰万菌素 / 大环内酯类 / p.73：目录定位显示 `泰万菌素` 属于 `大环内酯类`，可作为药物召回、类别边界和联用禁忌复核入口。 `source_id=SRC-0091; page=73`
