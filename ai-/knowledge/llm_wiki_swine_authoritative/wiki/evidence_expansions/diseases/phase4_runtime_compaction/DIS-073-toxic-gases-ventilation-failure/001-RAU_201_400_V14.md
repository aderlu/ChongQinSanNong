...
source_page: wiki/diseases/DIS-073-toxic-gases-ventilation-failure.md
...
# DIS-073-toxic-gases-ventilation-failure / RAU 201 400 V14
...
- 关联场景：呼吸困难/有毒气体。
- 药物/类别候选：呼吸系统支持药, 中枢兴奋药边界。
- 生成边界：必须优先通风、撤离和纠正环境，不得用兴奋药掩盖中毒。
