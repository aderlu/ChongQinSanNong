...
source_id: SRC-0085
updated: 2026-05-07T22:15:00+08:00
...
# Diseases of Swine 11e Chapter 69 Mycotoxins in Grains and Feeds

## 范围

- 来源：本地 PDF `docs/Diseases of Swine, 11th Edition ...pdf`
- 页码范围：PDF page 1079-1095
- 批次：formal-batch-030-v6-status-agnostic
- 解析器：PyMuPDF `fitz`、`pdfplumber`、`pdfminer.six`

## 摘要

Chapter 69 covers mold and mycotoxin risk in grains and feeds, acute and chronic mycotoxicosis patterns, feed testing, aflatoxins, trichothecenes/DON, zearalenone, ergot alkaloids and fumonisins.
