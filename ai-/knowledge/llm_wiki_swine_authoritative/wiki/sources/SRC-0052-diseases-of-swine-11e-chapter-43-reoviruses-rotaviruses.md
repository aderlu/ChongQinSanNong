...
# Diseases of Swine 11e Chapter 43 Reoviruses Rotaviruses and Reoviruses

## 范围

- 来源：本地 PDF `docs/Diseases of Swine, 11th Edition ...pdf`。
- 页码范围：PDF page 739-751。
- 批次：Formal Batch 021 / V3。

## 摘要

Chapter 43 covers rotavirus and reovirus taxonomy, environmental stability, pathogenesis, clinical enteric disease, diagnosis, immunity, treatment and control boundaries. PDF pages 748-751 are references.
