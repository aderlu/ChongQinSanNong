...
# Diseases of Swine 11e Chapter 63 Tuberculosis

## 范围

- 来源：本地 PDF `docs/Diseases of Swine, 11th Edition ...pdf`。
- 页码范围：PDF page 995-1004。
- 批次：Formal Batch 027 / V4。

## 摘要

Chapter 63 covers swine TB relevance, MTBC/MAC/MAH etiology, public-health boundary, epidemiology, sources, pathogenesis, lesions, diagnosis, sampling, prevention/control and references opening.
