...
created: 2026-05-06T15:45:00+00:00
updated: 2026-05-06T15:45:00+00:00
sources: []
---

# Diseases of Swine, 11th Edition - Chapter 25 African Swine Fever Virus opening

- 页码范围：PDF page 467-474。
- 可抽取范围：非洲猪瘟病毒相关性、公共卫生边界、病原学、流行病学、传播、发病机制、临床表现、病变、诊断、免疫和控制开端。PDF page 475-476 为参考文献，不生成事实。
- 本来源不直接生成固定药物处方、剂量、免疫程序、手术方案、屠宰/淘汰处置或中国监管结论。
