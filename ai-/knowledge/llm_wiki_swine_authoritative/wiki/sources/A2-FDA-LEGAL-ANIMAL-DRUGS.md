...
source_path: https://www.fda.gov/animal-veterinary/unapproved-animal-drugs/how-can-i-tell-if-drug-legally-marketed-animals
source_type: html
...
sources: []
raw_relpath: raw/urls/A2-FDA-LEGAL-ANIMAL-DRUGS-fda-how-to-tell-if-a-drug-is-legally-marketed-for-animals.html
sha256: e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855
http_status:
---

# FDA how to tell if a drug is legally marketed for animals

## 来源

- URL: https://www.fda.gov/animal-veterinary/unapproved-animal-drugs/how-can-i-tell-if-drug-legally-marketed-animals
- 本地缓存：`raw/urls/A2-FDA-LEGAL-ANIMAL-DRUGS-fda-how-to-tell-if-a-drug-is-legally-marketed-for-animals.html`
- SHA256: `e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855`
- HTTP status: ``
- Fetch error: `<urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: self-signed certificate in certificate chain (_ssl.c:1081)>`

## 可用范围

- 类别：`us_label_entry`。
- 用途：US legal-marketing boundary for animal drugs; supports label verification workflow.
