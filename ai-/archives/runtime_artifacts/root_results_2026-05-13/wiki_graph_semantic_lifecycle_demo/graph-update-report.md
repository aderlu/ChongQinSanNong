...
- Before: `D:\XF-ChongQin\ai-\results\wiki_graph_semantic_lifecycle_demo\knowledge-graph-before.html`
- After: `D:\XF-ChongQin\ai-\results\wiki_graph_semantic_lifecycle_demo\knowledge-graph-after.html`
- Diff JSON: `D:\XF-ChongQin\ai-\results\wiki_graph_semantic_lifecycle_demo\graph-update-diff.json`
...
- `GOV-8206135` (governance): create:candidate_only:accepted
- `GOV-8818888` (governance): create:candidate_only:accepted
- `GOV-9728686` (governance): create:candidate_only:closed
...
- `GOV-9728686` -> `SRC-0002` type=`governance-create` fact_id=`GOV-9728686`
